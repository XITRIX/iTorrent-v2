...
extension AppDelegate {
    ...
    class NotificationCenterDelegate: DelegateObject<AppDelegate>, UNUserNotificationCenterDelegate {
        ...
        func userNotificationCenter(_ center: UNUserNotificationCenter, didReceive response: UNNotificationResponse) async {
            ...
            await AppDelegate.showTorrentDetailScreen(with: torrentHandle)
        }
    }
}
